...
description: Autonomously improves the trial prompt for the clean_transcript experiment by hypothesizing changes, running experiments, and iterating until a perfect score, a python crash, or user interrupt. Use proactively when the user asks to start the autoresearch loop.
