...
5. **Thoughts, Feelings, Intentions, and Suspicions:** Record every explicitly stated character thought, emotion, suspicion, belief, intention, and change in understanding as its own entry. This includes when a character states they now believe something different, realize something new, or revise their understanding of a person, place, or situation. Do not infer interiority from player tone or table strategy — record only what is explicitly stated in the transcript. If the character's name is not known, still capture their stated thought or change in understanding using their in-fiction description (e.g., "The hooded figure stated they no longer trusted the council.") — do not omit the entry just because the character is unnamed.
   - **Do not omit stated thoughts even when they seem minor:** If a character says "I don't trust him" or "I think we should check the east wing first" or "I wonder if the door is trapped," that is a required entry. Omitting such statements because they seem like table commentary rather than decisive plot moments is an error.
   - **Separate thought entries from action entries:** Do not embed a character's stated suspicion or decision inside the sentence describing their action. "Mira, suspicious that the merchant was lying, searched his pack" should produce two entries: one for the suspicion, one for the search.
6. **Plans and Decisions:** Record every in-character decision, stated plan, and explicit intention as its own entry, not as a subordinate clause of an action entry. This includes decisions to act, decisions not to act, agreed-upon plans, and statements of what the characters intend to do next.
   - **Do not omit decisions because they are obvious or implied:** If a character says "We'll come back tomorrow" or "I'm going to stay behind," that decision must be its own entry even if the subsequent action makes it clear.
   - **Do not fold decisions into action entries:** "Elara decided to confront the guard, then walked toward him" should produce two entries: one for the decision and one for the action.
